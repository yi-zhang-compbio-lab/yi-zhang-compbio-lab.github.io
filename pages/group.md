...
##### Yichen Huang
I'm Yichen, a first-year PhD student in Duke’s Computational Biology and Bioinformatics (CBB) program. I earned my B.S. in Biochemistry and Mathematics from Brandeis University and M.S. in Computational Biology and Quantitative Genetics from the Harvard School of Public Health. My past research experiences focused on leveraging epigenetics to better understand complex human traits. I will be exploring methods to analyze transcriptomics of cell-cell interactions using high-resolution spatial genomics data. Outside of research, I enjoy playing volleyball, traveling, and PC gaming.
